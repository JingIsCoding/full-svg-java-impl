...
public class SVGMatrixTest {
    ...
    public void should_create_new_matrix_with_default_values(){
        ...
        assertThat(svgMatrix.getValues()[3], is(1d));
        assertThat(svgMatrix.getValues()[4], is(0d));
    ...
    public void should_multiply_matrix_correctly(){
        SVGMatrix svgMatrix = new SVGMatrix();
        SVGMatrix translate = new SVGMatrix(new double[]{1d,0d,0d,1d,5d,5d});
        ...
        assertThat(multiply.getValues()[3], is(1d));
        assertThat(multiply.getValues()[4], is(5d));
    ...
    public void should_translate_matrix_correctly(){
        ...
        assertThat(multiply.getValues()[2], is(0d));
        assertThat(multiply.getValues()[3], is(1d));
        assertThat(multiply.getValues()[4], is(3d));
    ...
    public void should_scale_matrix_correctly(){
        SVGMatrix svgMatrix = new SVGMatrix();
        SVGMatrix multiply = svgMatrix.scaleNonUniform(2d,3d);
        assertThat(multiply.getValues().length, is(6));
        assertThat(multiply.getValues()[0], is(2d));
        assertThat(multiply.getValues()[1], is(0d));
        assertThat(multiply.getValues()[2], is(0d));
        assertThat(multiply.getValues()[3], is(3d));
        assertThat(multiply.getValues()[4], is(0d));
    ...
    public void should_rotate_on_point(){
        ...
        assertThat(rotate.getValues()[2], is(-0.49999999999999994d));
        assertThat(rotate.getValues()[3], is(0.8660254037844387d));
        assertThat(rotate.getValues()[4], is(63.397459621556116d));
